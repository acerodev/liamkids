...
class MovimientosControlador
{
    ...
    /*===================================================================*/
    static public function ctrRegistrarMovi($movi_tipo, $movi_descripcion, $movi_monto, $caja_id, $movi_responsable)
    {
        $registroMovi = MovimientosModelo::mdlRegistrarMovi($movi_tipo, $movi_descripcion, $movi_monto, $caja_id, $movi_responsable);
        return $registroMovi;
    }
