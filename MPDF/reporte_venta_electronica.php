...
$html.='
	...
	<h4 style="text-align:center;display: inline-block;margin: 0px;padding: 0px;" ><b>'.strtoupper($row1['compro_tipo']).' DE VENTA</b></h4>
	...
	<table >
        ...
        <tr>
            ...
            <td> '.$row2['precio_ofertas'].'</td>
			<td> '.$row2['vd_descuento'].'</td>
            <td>'.number_format ((float)$row2['subtotal'], 2, '.', '').'</td>
...
// '.number_format ((float)$row1['total_venta'] - $row1['igv'] , 2, '.', '').'