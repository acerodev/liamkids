...
class CifrasEnLetras {
  ...
  */
  public static function convertirEurosEnLetras($euros, $nombresoles, $nombrecentimos, $numeroDecimales=2) {
    return self::convertirNumeroEnLetras($euros, $numeroDecimales, "euro", $nombresoles, false, "centimo", $nombrecentimos, false);
  }
