...
$mpdf = new \Mpdf\Mpdf([
    'mode' => 'utf-8' // Modo UTF-8
    //'default_font' => 'Arial', // Puedes cambiar la fuente aquí
]);
$query = "SELECT vc.nro_boleta,
                ...
                e.nro_cuenta
			FROM
				coti_cabecera vc INNER JOIN clientes c on 
...
while ($row1 = $resultado-> fetch_assoc()){
	...
	<html lang="en">
	  ...
	  if($row1['venta_estado'] == "REGISTRADA") {
		$html = '
		<body>
			...
			<thead >
				<tr>
					...
					<th width="30%" style="border-top:0px; border-left:0px; border-bottom:0px; border-right:0px; text-align:center;">
						<h3 style=""></h3><br>
                        <h2 style="color:black;">'.strtoupper($correla).'</h2><br>
		...
		<main>
		  <table  style="border-collapse; " border="1"  >
			...
			$query2 = "SELECT
						...
						FROM
							coti_detalle vd inner join productos p on 
		  ...
		  <div id="notices">
			<div></div>
			<div class="notice">'.utf8_decode('Agradecemos enviar &Oacute;rden de compra o Cotizaci&oacute;n firmada a: ').' '.$row1['email'].' <br><br>
            <b>Condiciones: </b><br><br>
            Forma de Pago &nbsp;&nbsp; :&nbsp;&nbsp; '.$row1['f_pago'].'<br> 

            Valid&eacute;z &nbsp;&nbsp; :&nbsp;&nbsp; '.$row1['validez'].' <br><br>
          
            <b>Dep&oacute;sitos: </b><br><br>'.$row1['cuenta'].' :  '.$row1['nro_cuenta'].'<br>
