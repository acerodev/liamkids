...
class MovimientosModelo
{
    ...
    =============================================*/
    static public function mdlRegistrarMovi($movi_tipo, $movi_descripcion, $movi_monto, $caja_id,  $movi_responsable)
    {
        try {
            //$fecha = date('Y-m-d');
            $stmt = Conexion::conectar()->prepare("INSERT INTO movimientos ( movi_tipo, 
                                                                                movi_descripcion, 
                                                                                movi_monto, 
                                                                                movi_fecha,movi_caja, caja_id, movi_responsable )
                                                                    VALUES(:movi_tipo,
                                                                            :movi_descripcion,
                                                                            :movi_monto, 
                                                                            CURRENT_TIMESTAMP(), 'VIGENTE', :caja_id, :movi_responsable)");
            ...
            $stmt->bindParam(":movi_responsable", $movi_responsable, PDO::PARAM_STR);
