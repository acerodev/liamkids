...
class UsuarioModelo{
    ...
    static public function mdlObtenerNombre_sistema()
    {

        $stmt = Conexion::conectar()->prepare("SELECT nombre_sistema, imagen, moneda, tipo_impuesto, igv, soles, centimos FROM empresa");
