            ...
            <div class="col-md-12">
                <div class="card card-info card-outline shadow ">
                    <div class="card-header">
                        <h3 class="card-title">Reporte de Ventas a Credito</h3>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i
                                                    class="far fa-calendar-alt"></i></span></div>
                                        <input type="date" class="form-control form-control-sm" max="<?php echo date("Y-m-d"); ?>" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" id="text_fecha_F_cr">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-8 d-flex flex-row align-items-center justify-content-end">
                                <div class="form-group m-0"><a class="btn btn-primary btn-sm" style="width:120px;" id="btnFiltrar_cr">Buscar</a></div>
                            </div>
                        </div><br>
                            ...
                            <table id="tbl_ventas_credito"
                                ...
                                <thead class="bg-info text-center">
                                    <tr>
                                        ...
                                        <th>Abonado <?php echo $nombre_sist2[0]['moneda'] ; ?></th>
                                        <th>Estado</th>
                                    </tr>
                                </thead>
...
<script>
var accion;
var  tbl_ventas_mes_anio, tbl_ventas_anio, tbl_ventas_comp_anual, tbl_ventas_ganancia, tbl_ventas_credito;
...
$(document).ready(function() {
    ...
    $.ajax({
     ...
     /****************************************** */
    //FILTRAR EN EL REPORTE VENTAS A CREDITO
    /****************************************** */
    $("#btnFiltrar_cr").on('click', function() {
            filtrarVentasCreditoFechas();
            validar_vent_cred();
    })
    ...
    /****************************************** */
    function filtrarVentasCreditoFechas() {
        fecha_ini_cr = $("#text_fecha_I_cr").val(); //capturamos el valor
        fecha_fin_cr = $("#text_fecha_F_cr").val();

        tbl_ventas_credito = $("#tbl_ventas_credito").DataTable({
            responsive: true,
            destroy: true,
            //paging: false,
            async: false,
            ...
            buttons: [{
                    "extend": 'excelHtml5',
                    "title": 'Reporte ventas a credito',
                    "exportOptions": {
            ...
            ajax: {
                ...
                data: {
                    'accion': 10,
                    'fecha_ini': fecha_ini_cr,
                    'fecha_fin': fecha_fin_cr
                }, //LISTAR 
            },
            columnDefs: [
    ...
    function filtroGananciasporFechas() {
        ...
        tbl_ventas_ganancia = $("#tbl_ventas_ganancia").DataTable({
            ...
            buttons: [{
                    "extend": 'excelHtml5',
                    "title": 'Reporte ganancias por fechas - credito',
                    "exportOptions": {
    ...
    function fechas() {
        ...
        document.getElementById('text_fecha_I_cr').value = anio + "-" + mes + "-" + d;
        document.getElementById('text_fecha_F_cr').value = anio + "-" + mes + "-" + d;
    ...
    function validar_vent_cred() {
        let fecha_ini_crd = document.getElementById('text_fecha_I_cr').value;
        let fecha_fin_crd = document.getElementById('text_fecha_F_cr').value;
        if (fecha_ini_crd.length == 0) {
        ...
        if (fecha_ini_crd > fecha_fin_crd) {
            Toast.fire({
                icon: 'error',
                title: 'Fecha inicio es mayor que la de fin'
            })
