                ...
                <div class="row">
                    ...
                    <div class="col-4" hidden>
                        <div class="form-group mb-2">
                            ...
                            <a class="btn btn-success " id="btnabrircamara">Iniciar</a>
                    ...
                    <div class="col-4" hidden>
                        <div class="form-group mb-2">
                            ...
                            <a class="btn btn-danger " id="btncerrarcamara">Apagar</a>
                        </div>
                    </div>
                    <div class="col-4" id="ocul_tomarfot" hidden>
                        <div class="form-group mb-2">

                            <a class="btn btn-info " id="btntomarfoto">Tomar foto</a>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-5" id="ocul_img">
                    ...
                    <div class="col-md-12 center" id="ocul_video" hidden>
                            <video id="video" autoplay muted style="max-width: 100%; height: auto;"> </video>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#btnCancelarMod_foto", "#btnCerrarModalMod_foto").on('click', function() {
            $("#ocul_img").prop('hidden', false);
            $("#ocul_video").prop('hidden', true);
            $("#ocul_tomarfot").prop('hidden', true);
            $("#video").addClass("none");
            turnoffCamera();
    ...
    =========================================================================================*/
        $("#btnGenerarCodeBarra").on('click', function() {
            ...
            if (fila == 0) {
                ...
                window.open("MPDF/reporte_codigo_barras.php?codigo=" + parseInt(cod_b) + "&contador=" +
                    parseInt(fila) + "&idtalla=" + parseInt(id_t) + "&columna=" + parseInt(col) +
                    "#zoom=90", "Generar codigo de barras", "scrollbards=NO");
   ...
   //GENERAR CATALOGO - ABRIR MODAL
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    datos.append("codigo_producto",
                        codigo_producto); //jalamos el codigo que declaramos mas arriba
    ...
    function turnOnCamera() {
        ...
        if (navigator.getUserMedia) {
            ...
            Toast.fire({
                icon: 'warning',
                title: 'User Media No Disponible'
            });
    ...
    $("#btnabrircamara").click(function() {
        $("#ocul_img").prop('hidden', true);
        $("#ocul_video").prop('hidden', false);
        $("#ocul_tomarfot").prop('hidden', false);
    ...
    // Convertir la imagen del canvas a un archivo PNG
    ...
    // Asignar el objeto DataTransfer al input tipo file
    var input = document.getElementById('text_imagen_m');
    input.files = dataTransfer.files;
}

//text_imagen_m

// Función para convertir una URL de datos en un Blob
