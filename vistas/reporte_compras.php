            ...
            <div class="col-md-12">
                <div class="card card-info card-outline shadow ">
                    <div class="card-header">
                        <h3 class="card-title">Reporte de Compras del dia</h3>
...
<!-- Main content - COMPRAS POR MES Y AÑO -->
<div class="content pb-2">
    <div class="container-fluid">
        <div class="row p-0 m-0">
            <div class="col-md-12">
                <div class="card card-info card-outline shadow ">
                    <div class="card-header">
                        <h3 class="card-title">Reporte Compras por Mes y Año</h3>
...
<!-- Main content - COMPRAS GENERAL ANUAL -->
<div class="content pb-2">
    <div class="container-fluid">
        <div class="row p-0 m-0">
            <div class="col-md-12">
                <div class="card card-info card-outline shadow ">
                    ...
                    <div class=" card-body">
                        ...
                        <div class="table-responsive">
                            <table id="tbl_compras_comp_anual"
                                class="table display table-hover text-nowrap compact  w-100  rounded">
                                <thead class="bg-info text-center">
                                    <tr>
                                        <th>Año</th>
...
<script>
var accion;
var tbl_compras_dia, tbl_compras_mes_anio, tbl_compras_anio, tbl_compras_comp_anual;
...
$(document).ready(function() {
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            $("#select_anio_com_a").append(options);
        }
    });
...
function filtroporFechas() {
    ...
    tbl_compras_dia = $("#tbl_compras_dia").DataTable({
        responsive: true,
        destroy: true,
        //paging: false,
        async: false,
...
/****************************************** */
//LISTAS LAS COMPRAS MES Y AÑO
/****************************************** */
function filtroporMesyAnio() {
    mes = $("#select_mes_compra").val(); //capturamos el valor
    anio = $("#select_anio_com_a").val();
    // console.log(mes, anio);

    tbl_compras_mes_anio = $("#tbl_compras_mes_anio").DataTable({
        responsive: true,
        destroy: true,
        //paging: false,
        async: false,
        ...
        buttons: [{
                "extend": 'excelHtml5',
                "title": 'Reporte compras de Mes y año',
                "exportOptions": {
                    'columns': [0, 1, 2, 3, 4, 5]
                },
                "text": '<i class="fa fa-file-excel"></i>',
...
function filtroPorAnio() {
    ...
    tbl_compras_anio = $("#tbl_compras_anio").DataTable({
        responsive: true,
        destroy: true,
        //paging: false,
        async: false,
...
function filtroComparativoAnual() {
        ...
        tbl_compras_comp_anual = $("#tbl_compras_comp_anual").DataTable({
          responsive: true,
          destroy: true,
          //paging: false,
          async: false,
...
function validarMesyAnio() {
    let mes_v = document.getElementById('select_mes_compra').value;
    let anio_v = document.getElementById('select_anio_com_a').value;
    if (mes_v.length == 0) {
