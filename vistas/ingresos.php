                      ...
                      <div class="row">
                          ...
                          <div class="col-lg-12">
                              <div class="form-group mb-2">
                                  ...
                                  <input type="text" class=" form-control form-control-sm" id="text_monto"  placeholder="Monto" required>
                          ...
                          <div class="col-lg-12">
                              <div class="form-group mb-2">
                                  ...
                                  <input type="text" class=" form-control form-control-sm" id="text_respon" placeholder="Responsable " required>
                                  <div class="invalid-feedback">Debe ingresar un Responsable</div>
                  ...
                  if (form.checkValidity() === true) {
                      ...
                      Swal.fire({
                          ...
                          if (result.isConfirmed) {
                              ...
                              datos.append("movi_responsable", $("#text_respon").val());
          ...
          $("#tbl_movimientos tbody").on('click', '.btnEditarMovimientos', function() {
              ...
              if (tbl_movimientos.row(this).child.isShown()) {
                  ...
                  var data = tbl_movimientos.row($(this).parents('tr')).data(); //OBTENER EL ARRAY CON LOS DATOS DE CADA COLUMNA DEL DATATABLE
                   // console.log("🚀 ~ file: MOVIMIENTOS.php ", data);
              }
