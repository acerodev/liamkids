              ...
              <div class="col-md-12">
                  <div class="card card-info card-outline shadow ">
                      <div class="card-header">
                          ...
                          <button class="btn btn-info btn-sm float-right" id="abrirmodal_usuario"><i class="fas fa-plus"></i>
                              Nuevo</button>
                      </div>
                      <div class=" card-body">
                      ...
                      <div class="row">
                          ...
                          <div class="col-lg-12">
                              <div class="form-group mb-2" id="iptclave">
                                  ...
                                  <input type="text" class=" form-control form-control-sm" id="text_clave" name="text_clave" placeholder="Clave" required>
                      ...
                      <div class="row">
                          <div class="col-lg-12">
                              <div class="form-group mb-2">
                                  ...
                                  <input type="text" class=" form-control form-control-sm" id="text_clave_nueva" placeholder="Clave nueva" required>
                          ...
                          <div class="col-lg-12">
                              <div class="form-group mb-2">
                                  ...
                                  <input type="text" class=" form-control form-control-sm" id="text_clave_repetir"  placeholder="Repetir clave" required>
  ...
  <script>
      ...
      $(document).ready(function() {
                  ...
                  if (form.checkValidity() === true) {
                      ...
                      Swal.fire({
                          ...
                          if (result.isConfirmed) {
                              ...
                              datos.append("nombre_usuario", $("#text_nombres").val()); //modulo
          ...
          document.getElementById("btnregistrar_clave").addEventListener("click", function() {
              ...
              var forms = document.getElementsByClassName('needs-validation');
              // Loop over them and prevent submission
              let clave = document.getElementById('text_clave_nueva').value;
              let clave_repetir = document.getElementById('text_clave_repetir').value;
             // console.log(clave);
          ...
          $("#tbl_usuarios tbody").on('click', '.btnEliminarUsuario', function() {
              ...
              Swal.fire({
                  ...
                  if (result.isConfirmed) {
                      ...
                      datos.append("accion", accion);
                      datos.append("id_usuario", id_usuario); //jalamos el codigo que declaramos mas arriba
