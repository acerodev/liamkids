            ...
            <div class="col-md-12">
                <div class="card card-info card-outline shadow ">
                    <div class="card-header">
                        <h3 class="card-title">Pivot Ventas</h3>

                    </div>
                    <div class=" card-body">

                        <div class="table-responsive">
                            <table id="tbl_pivot_v"
...
<script>
var accion;
var tbl_pivot_v, tbl_record_usu;
...
/****************************************** */
function PivotVentas() {

    tbl_pivot_v = $("#tbl_pivot_v").DataTable({
        responsive: true,
        destroy: true,
        //paging: false,
        async: false,
