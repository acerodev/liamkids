                ...
                <div class="card card-info card-outline shadow ">
                    ...
                    <div class=" card-body">
                        ...
                        <div class="table-responsive">
                            <table id="tbl_lista_compras" class="table display table-hover text-nowrap compact  w-100  rounded">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-gray py-1 align-items-center">
                <h5 class="modal-title" id="titulo_modal_cliente">Detalle de la Compra</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="table-responsive">
                        <table id="tbl_detalle_compras" class="table display table-hover text-nowrap compact  w-100  rounded" style="width:100%;">
                            <thead class="bg-info text-left">
                                <tr>
...
<script>
    var accion;
    var tbl_lista_compras, fecha_ini, fecha_fin, tbl_detalle_compras;
    ...
    $(document).ready(function() {
        ...
        /* =========================================================================================*/
        $("#tbl_lista_compras tbody").on('click', '.btnVerDetalle', function() {
            //tbl_report_cliente.destroy();
            //accion = 2; //seteamos la accion para Eliminar

            if (tbl_lista_compras.row(this).child.isShown()) {
                var data = tbl_lista_compras.row(this).data();
            } else {
                var data = tbl_lista_compras.row($(this).parents('tr')).data(); //OBTENER EL ARRAY CON LOS DATOS DE CADA COLUMNA DEL DATATABLE
               // console.log(data);
            }
         ...
         /* ======================================================================================*/
           // IMPRIMIR EN PDF
        /* =========================================================================================*/
        $("#tbl_lista_compras tbody").on('click', '.btnImprimir', function() {
            //tbl_report_cliente.destroy();
            //accion = 2; //seteamos la accion para Eliminar
            ...
            window.open("MPDF/reporte_compra.php?codigo=" + data[4] + "#zoom=90", "Orden de Compra", "scrollbards=NO");
        ...
        /* ======================================================================================*/
           // IMPRIMIR EN TICKET
        /* =========================================================================================*/
        $("#tbl_lista_compras tbody").on('click', '.btnTicket', function() {
            //tbl_report_cliente.destroy();
            //accion = 2; //seteamos la accion para Eliminar
         ...
         ***************************************************************/
        $('#tbl_lista_compras tbody').on('click', '.btnAnular', function() {
            ...
            var nro_compra = data[4]; //CAPTURAMOS EL NRO BOLETA DEL DATATABLE
            //console.log(nroBoleta);

            Swal.fire({
                title: 'Anular Compra "' + nro_compra + '"?',
                icon: 'warning',
    ...
    function filtroporFechas() {
        ...
        tbl_lista_compras = $("#tbl_lista_compras").DataTable({
            responsive: true,
            destroy: true,
            //paging: false,
            async: false,
            ...
            buttons: [{
                    "extend": 'excelHtml5',
                    "title": 'Reporte listado de compras por rango',
                    "exportOptions": {
    ...
    /****************************************** */
    function Traer_Detalle(nro_compra) {
        tbl_detalle_compras = $("#tbl_detalle_compras").DataTable({
            responsive: true,
            destroy: true,
            searching: false,
            dom: 't',
